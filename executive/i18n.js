...
(() => {
  ...
  const DE = {
    ...
    'I also publish peer-reviewed work on cyber risk, systems security and database systems, and I build the systems behind it: a database engine, an XDR platform, an evidence engine for edge telemetry, and a set of shipped iOS and macOS apps.': 'Daneben veröffentliche ich peer-reviewte Arbeiten zu Cyber-Risiko, Systemsicherheit und Datenbanksystemen und baue die Systeme dazu: eine Datenbank-Engine, eine XDR-Plattform, eine Evidence-Engine für Edge-Telemetrie sowie mehrere veröffentlichte iOS- und macOS-Apps.',
