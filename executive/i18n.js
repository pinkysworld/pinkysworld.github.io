...
(() => {
  ...
  const DE = {
    ...
    'Writing papers has made me stricter about saying what a result actually shows and what it does not.': 'Durch das Schreiben von Fachartikeln bin ich strenger darin geworden, zu sagen, was ein Ergebnis wirklich zeigt und was nicht.',
    'Understand the problem first': 'Zuerst das Problem verstehen',
    'Work out which parts are requirements and which are assumptions, before quoting a solution or a price.': 'Erst klären, was Anforderung ist und was Annahme. Danach eine Lösung oder einen Preis zusagen.',
    'Design for how it will be run': 'Für den Betrieb entwerfen',
    'The people on the support rota have to be able to operate it, so their constraints belong in the design.': 'Wer es später betreibt, muss damit arbeiten können. Diese Randbedingungen gehören in den Entwurf.',
    ...
    'A prototype, a tested result and a proposal are different things, and I label them as such.': 'Prototyp, geprüftes Ergebnis und Vorschlag sind drei verschiedene Dinge. Ich schreibe dazu, was jeweils vorliegt.',
